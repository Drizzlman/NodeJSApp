...
class Feed extends Component {
  ...
  loadPosts = direction => {
    ...
    fetch('http://localhost:8080/api/feed/posts?page=' + page, {
      headers: {
        Authorization: 'Bearer ' + this.props.token
      }
    })
  ...
  finishEditHandler = postData => {
    ...
    let url = 'http://localhost:8080/api/feed/post';
    let method = 'POST';
    if (this.state.editPost) {
      console.log(this.state)
      url = 'http://localhost:8080/api/feed/post/' + this.state.editPost.id;
      method = 'PUT';
    }
    ...
    fetch(url, {
      ...
      .then(resData => {
        ...
        const post = {
          ...
          user: resData.user !== undefined ? resData.user : resData.post.user,
  ...
  deletePostHandler = postId => {
    ...
    fetch('http://localhost:8080/api/feed/post/' + postId, {
      method: 'DELETE',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      }
